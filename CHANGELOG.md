...
- Web UI extraction builder at `/builder`: drag schema, extract, swarm, and custom steps onto a pipeline, reorder them, and run each step through `POST /api/extract`.
